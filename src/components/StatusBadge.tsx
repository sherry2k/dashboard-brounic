...
const styles: Record<string, string> = {
  ...
  not_started: "bg-white text-[#6B6B6B] ring-[#2E2E2E]/15 border border-[#E5E5E5]",
  preparing: "bg-[#FFB347]/20 text-[#6B3F00] ring-[#FFB347]/30",
  submitted: "bg-[#F7941D]/15 text-[#7A3E00] ring-[#F7941D]/30",
  approved: "bg-[#111111] text-white ring-[#111111]/20",
  revision_required: "bg-[#FFF3E0] text-[#7A3E00] ring-[#F7941D]/40",
};
